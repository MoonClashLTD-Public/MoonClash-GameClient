...
import { CSCardAttrBanner } from '../../card/com/attrBanner/CSCardAttrBanner';
import { CardSystemUtils } from '../../card/utils/cardSystemUtils';
import { ICSCardPopCfg, ICSCardPopNetCfg, ICSResetAttrPopCfg } from '../../card/utils/enum';
...
@ccclass('PVECardInfoPop')
export class PVECardInfoPop extends Component {
    @property(Layout)
